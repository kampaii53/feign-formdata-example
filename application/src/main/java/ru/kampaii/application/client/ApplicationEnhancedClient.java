...
@FeignClient(name = "application-client-form-enhanced", url = "localhost:8081"
        , configuration = ApplicationEnhancedClient.Configuration.class
)
public interface ApplicationEnhancedClient {
